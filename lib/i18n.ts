...
export const translations = {
  ...
  fr: {
    ...
    hero: { badge:'🎉 Livraison Gratuite dans le Monde Entier', title1:'Le Bain que', title2:'les Enfants Adorent', subtitle:'Des bombes de bain effervescentes avec jouets surprises — transformez chaque bain en aventure que vos enfants réclament.', cta:'Découvrir', cta2:'Voir tous les produits', reviews:"4,9/5 — Plus de 2 400 enfants ravis" },
    product: { addToCart:'Ajouter au panier', addingToCart:'Ajout...', buyNow:'Acheter maintenant — ', outOfStock:'Rupture de stock', inStock:'En stock', fewLeft:'Plus que quelques-uns !', free:'OFFERT', ebook:'+ E-book offert', reviews:'avis', shipping:'Livraison standard offerte', guarantee:'Satisfait ou remboursé 30 jours', secure:'Paiement 100% sécurisé' },
    collection: { title:'Notre Collection', subtitle:'Choisissez votre pack Fizzloo idéal', from:'À partir de', pieces:'bombes' },
    sections: { howItWorks:'Comment ça marche ?', step1title:'Déposez-la', step1desc:"Plongez une bombe Fizzloo dans l'eau chaude et regardez la magie opérer", step2title:'Regardez le spectacle', step2desc:'Les couleurs tourbillonnent et les bulles envahissent le bain', step3title:'Trouvez la surprise !', step3desc:'En se dissolvant, la bombe révèle un jouet mystère !', whyFizzloo:'Pourquoi les parents adorent Fizzloo', natural:'Formule 100% Naturelle', naturalDesc:'Ingrédients biologiques, doux pour la peau.', surprise:'Une Nouvelle Surprise à Chaque Fois', surpriseDesc:"Les enfants ne savent jamais quel jouet ils vont découvrir !", bathTime:'Fini les Batailles du Bain', bathTimeDesc:'Les enfants qui détestaient le bain courent maintenant vers la salle de bain !', safe:'Sûre pour les Peaux Sensibles', safeDesc:'Testé dermatologiquement, hypoallergénique, adapté dès 3 ans.', reviews:'Ce que disent les parents', faq:'Questions Fréquentes' },
    footer: { tagline:'La Magie du Bain pour Chaque Enfant', legal:'Légal', terms:'CGV', privacy:'Politique de confidentialité', shipping:'Livraison & Remboursement', legal_notice:'Mentions légales', follow:'Suivez-nous', rights:'Tous droits réservés.' },
    ...
    tracking: { title:'Suivre ma Commande', placeholder:'Entrez votre numéro de commande', cta:'Suivre' }
  }
}

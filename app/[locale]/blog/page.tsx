...
const POSTS = [
  {slug:'bath-time-routine-kids',emoji:'🛁',date:'March 15, 2025',readTime:'4 min',color:'#d6eaff',title:{en:'5 Tips to Make Bath Time Fun for Kids',fr:'5 astuces pour rendre le bain amusant'},excerpt:{en:'Bath time struggles are real. Here are 5 proven strategies to transform your routine.',fr:'La routine du bain peut etre transformee. Voici 5 strategies prouvees.'},category:{en:'Parenting Tips',fr:'Conseils Parents'}},
  {slug:'natural-bath-products-children',emoji:'🌿',date:'March 8, 2025',readTime:'6 min',color:'#d6f5ee',title:{en:"Natural Bath Products for Children",fr:"Produits de bain naturels pour enfants"},excerpt:{en:"Children skin is very sensitive. Choose natural products.",fr:"La peau des enfants est tres sensible. Choisissez des produits naturels."},category:{en:'Health',fr:'Sante'}},
  {slug:'sensory-play-bath-time',emoji:'🌈',date:'March 1, 2025',readTime:'5 min',color:'#fde8f0',title:{en:'Sensory Play During Bath Time',fr:'Jeu sensoriel pendant le bain'},excerpt:{en:'Bath time is perfect for sensory exploration.',fr:"Le bain est ideal pour l'exploration sensorielle."},category:{en:'Development',fr:'Developpement'}},
